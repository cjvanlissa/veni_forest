...
More exploratory research is thus needed to not only complete the cycle, but to enable tests confirmatory prediction following from exploratory approaches.
...
The sample might also be somewhat dated - especially considering daily life has changed drastically for youth coming of age in a post-pandemic world. The WEIRD nature of the sample constrict us in generalizing beyond such populations from these findings.

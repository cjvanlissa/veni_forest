...
This allows us, for the first time, to assess the relative importance of different (themes of) predictors, where prior work has taken a more fragmented approach that does not allow for such comparisons.

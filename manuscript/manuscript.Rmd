...
```
Participants were 497 Dutch adolescents and their parents enrolled in the ongoing longitudinal study `r ifelse(mask, "RADAR [@branjeResearchAdolescentDevelopment2018]", "**(masked reference)**")`, which 
received ethical approval from the ethical committee of the University Medical Centre `r ifelse(mask, "Utrecht", "**masked**")`.
The `r ifelse(mask, "RADAR", "**masked**")` sample was recruited from over 200 randomly selected elementary schools in the province of `r ifelse(mask, "Utrecht", "**masked**")`, and four main cities in `r ifelse(mask, "The Netherlands", "**masked**")`.

...
Several theories are commonly cited in research on adolescent emotion regulation [for a review, see @vanlissaMappingPhenomenaRelevant2021].
...
Two macro-theories that have been influential in research on emotion regulation development are the bioecological model [@bronfenbrennerBioecologicalModelHuman2007; e.g., see @augustEmotionRegulationAtRisk2017] and the transactional model [@sameroffUnifiedTheoryDevelopment2010].
...
Other theories are more specific, focusing on cognitive maturation and the role of primary caregivers.
This includes the theory of normative emotional development [@sroufeAttachmentDyadicRegulation1996]
...
Note that the tripartite model explicitly addresses the life phase of adolescence.<!--is one of the few theories that -->
...
They identify relevant phenomena by grouping related keywords,
and ranking these by number of studies those keywords occur in.<!-- reflection and meaning-making-->
This review offers a relatively comprehensive overview of potentially relevant phenomena.
The present study used it as a starting point for an empirical investigation of potential predictors of adolescents' emotion regulation development.

According to this review, the phenomena that received most attention in the literature were related to internalizing and externalizing problems, and mental health.
Although these phenomena are likely to be, at least in part, outcomes of emotion dysregulation - that does not diminish their usefulness as predictors.
Some of the phenomena that were identified using text mining reflect what has been discussed in prior narrative reviews,
including cognitive development, parenting, and external stressors [cf. @coe-odessEmergentEmotionsAdolescence2019].
Other identified phenomena had received less attention in prior theory and reviews,
...
From 2006 to 2011, trained interviewers conducted annual home visits to collect questionnaire data from adolescents and parents.
...
```{r figpdp1, fig.cap="Predicted trajectory of difficulties in emotion regulation for predictors 1-20."}
knitr::include_graphics("../plots/pdp1-20.png")
```
```{r figpdp2, fig.cap="Predicted trajectory of difficulties in emotion regulation for predictors 21-40."}
knitr::include_graphics("../plots/pdp21-40.png")
```
```{r figpdp3, fig.cap="Predicted trajectory of difficulties in emotion regulation for predictors 41-60."}
knitr::include_graphics("../plots/pdp41-60.png")
```
```{r figpdp4, fig.cap="Predicted trajectory of difficulties in emotion regulation for predictors 61-87."}

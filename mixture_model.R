...
saveRDS(res_mp, "mix_mplus.RData")
desc <- mixtureSummaryTable(res_mp)
write.csv(desc, "supplemental_table_2.csv", row.names = FALSE)
classlabs <- paste0(c("Low", "High"), ": ", round(res_mp$mix_2_class.out$results$class_counts$modelEstimated$proportion*100), "%")

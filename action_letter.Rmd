...
library(revise)
man <- read_manuscript("manuscript/manuscript.Rmd")
letter <- read_manuscript("action_letter.Rmd")
mask = TRUE
```
...
`r get_revision("priorlit", letter, quote = F)`
...
`r get_revision(manuscript = man, "globalnorth")`
...
`r get_revision(manuscript = man, "velez1")`

And the following in the Discussion:

`r get_revision(manuscript = man, "velezagosto")`
...
`r get_revision(manuscript = man, "waves")`

Geographic location:

`r get_revision(manuscript = man, "dutch")`

\RC{Also, as reviewer 1 suggests, please explain the methodology used to extract predictors in more detail.}

`r get_revision(manuscript = letter, "extractpreds", quote = F)`
...
`r get_revision(manuscript = man, "parenting")`

And:

`r get_revision(manuscript = man, "parentrelated")`
</span>
...
`r get_revision(manuscript = man, "overlap")`
...
`r get_revision(manuscript = man, "cfi")`
...
`r get_revision(manuscript = man, "missing")`
</span>
...
`r get_revision(manuscript = man, "homogeneity")`

And by addressing it further in the Limitations section:

`r get_revision(manuscript = man, "homogeneity2")`
...
`r get_revision(manuscript = man, "stepiii")`
...
`r get_revision(manuscript = man, "fullygrown")`
...
`r get_revision(manuscript = man, "semforests")`
...
`r get_revision(manuscript = man, "predictions")`
...
`r get_revision(manuscript = man, "nonlinearexample")`
...
`r get_revision(manuscript = man, "limitations")`
...
`r get_revision(manuscript = man, "posthoc")`
...
`r get_revision(manuscript = man, "errata")`
...
`r get_revision(manuscript = man, "includepersonality")`
...
parenting behavior". Balanced relatedness is not a parenting practice (i.e., a specific action parents engage in as part of child rearing). Rather, it is an aspect of the (adolescent-perceived) emotional family climate. `r get_revision(manuscript = letter, "parents", quote = F)`
...
`r get_revision(manuscript = man, "causality")`
...
`r get_revision(manuscript = man, "singlefactor")`
...
`r get_revision(manuscript = man, "motherfather")`
...
`r get_revision(manuscript = man, "abstract")`
...
`r get_revision(manuscript = man, "abundantlit")`
</span>
...
`r get_revision(manuscript = man, "entropy")`
...
`r get_revision(manuscript = man, "percentiles")`
...
`r get_revision(manuscript = letter, "parents", quote = F)`
...
`r get_revision(manuscript = man, "highrankingparent")`
...
`r get_revision(manuscript = man, "riskassessment")`
...
`r get_revision(manuscript = man, "culture")`

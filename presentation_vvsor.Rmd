---
title: "Closing the empirical cycle"
author: "Using machine learning for rigorous exploration"
date: "Caspar J. Van Lissa<p>Utrecht University | Open Science Community Utrecht<br>Tilburg University<br>Funded by NWO Veni grant  VI.Veni.191G.090</p>"
...
```{r, out.width="100%"}
knitr::include_graphics("unguidedvrigorous.png")
```
...
Substantial empirical research, but no overarching theoretical framework [@bussTheoriesEmotionalDevelopment2019]
...
* DV: quadratic growth model of Difficulties in emotion regulation [@gratzMultidimensionalAssessmentEmotion2004]

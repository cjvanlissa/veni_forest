...
> **Theory**: A (causal?) explanation of phenomena reliably evidenced by data [@bogenSavingPhenomena1988]

* Allows for derivation of testable hypotheses for deductive research
...
Most social scientific theories are [@scheelWhyMostPsychological2022]:

* insufficiently precise
* too flexible
* But cf. @walasekEvolutionaryModelSensitive2022

## Why do we need theory?

* Social science strives to understand, not only predict
...
* Model of cumulative knowledge acquisition through scientific research [@degrootMethodologieGrondslagenVan1961]
...
* **Cross-validated patterns of association** may constitute phenomena
* **Text mining** existing literature may reveal what phenomena other authors have identified [@vanlissaMappingPhenomenaRelevant2021]
...
* Assumption for causal interpretation
    + But mind multicolinearity and collider bias
...
* Include potential predictors from various theories, and undertheorized factors
    + Assess the relative utility across studies
    + Cannot do this across studies
...
Some methods allow for theory guided exploration using machine learning

When (part of) the theory can be expressed as a structural equation model, and part still remains to be discovered through exploratory research

* E.g., some relevant constructs are latent variables
* E.g., development follows a latent growth curve (LGC)
...
Call for person-centered research [@laursenPersonCenteredVariableCenteredApproaches2006]
...
* Multilevel models
    + Allow for, but rarely explain heterogeneity
    + Includes RI-CLPM and DSEM
    + Could use regularized SEM or SEM forests
* Tree-based models
...
ML: Checks and balances to curtail *overfitting*
...
* Start with "interpretable machine learning" metrics [@henningerInterpretableMachineLearning2022]
...
* "Light" version of AFTC: Comparing predictive performance of simpler parametric model based on "interpretation" to more flexible machine learning model
...
Rasoul Norouzi is further developing this method

* Goal: Reconstructing a causal loop diagram based on authors' causal claims in literature

Together with Denny Borsboom, applying TMSR v2 to Cooperation Databank

* Using sciBERT vector embeddings and HDBSCAN clustering instead of dictionary 
...
# Example: Predictors of Infection Prevention Behavior

## Context

Prior to vaccines, infection prevention behaviors were the only defense against COVID

Behavioral science could thus inform policy

Existing theories suggest a limited set of relevant predictors

We used ML to cast a wider net and identify important predictors at the individual and country level

## Study design

**Participants**

* PsyCorona consortium
* 56.072 participants across 28 countries
* Collected between March-May 2020

## Variables

* DV: Self-reported infection prevention behaviors (handwashing, avoiding crowds, isolation)
* IVs: 80 individual-level variables (16 multi-item composites)
* Enriched with 35 country-level variables
    + E.g., political stability, government effectiveness
    + Some matched to date of participation (pandemic severity, government response)
...
```{r, out.height="100%"}
knitr::include_graphics("presentation/varimp_covid.png")
```

## Summary

* Injunctive norms most important
    + Consistent with theory of planned behavior
* Coping styles were important:
    + Problem-focused coping, focus on the present/ future, hopefulness
* Five of most important predictors were country-level variables
    + E.g., national healthcare infrastructure

## Notable absences

* Perceived likelihood of infection
    + Contradicts Health Belief Model
* Psychological and material struggle
    + E.g., loneliness, boredom, job insecurity
* No evidence for "intergenerational conflict of interest"
    + Confirmed by preregistered studies
    
## Strengths

This sample included a representative sub-sample

* Allowed us to estimate generalizability
* Predictive $R^2$ in the representative subsample was even higher than in the total hold-out sample ($R^2_{rep} = .59$, $R^2_{test} = .52$)
...
## Recall: Characteristics of Good Theory
...
* 1-2 can be described by a causal network (DAG), 3-6 refer to the nature of associations within that network
* Augmented causal networks (ACN, see Crielaard et al., 2022)
...
Working on this with Aaron Peikert, Andreas Brandmaier and Felix Schönbrodt

## Learning a causal network

For example, using TMSR, based on what previous authors have written

Working on this with my PhD student, Rasoul Norouzi

## Epistemology

Working on an epistemology of machine learning-informed theory formation

With Denny Borsboom and James Woodward
...
Douglas, K., Sutton, R. M., Van Lissa, C. J., ... & N Pontus, L. (2023). Identifying Important Individual-and Country-Level Predictors of Conspiracy Theorizing: A Machine Learning Analysis. European Journal of Social Psychology. DOI: 10.1002/ejsp.2968

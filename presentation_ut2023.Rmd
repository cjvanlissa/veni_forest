---
title: "How Machine Learning can Advance Theory Formation"
...
* abductive formal theory construction (AFTC) framework
    ...
    + Generate data
    + Mathematically compare to empirical data (like posterior predictive check in Bayes)
...
Augmented causal networks (ACN)

* encode both causal relationships and the nature of those relationships
* can be shared in plain text (YAML-type) data
* imply testable hypotheses
* can be shared and updated by multiple researchers
...
Van Lissa, C. J. (2022). Developmental data science: How machine learning can advance theory formation in Developmental Psychology. Infant and Child Development, n/a(n/a), e2370. https://doi.org/10.1002/icd.2370

Van Lissa, C. J. (2022). Complementing preregistered confirmatory analyses with rigorous, reproducible exploration using machine learning. Religion, Brain & Behavior, 0(0), 1–5. https://doi.org/10.1080/2153599X.2022.2070254

Van Lissa, C. J., Beinhauer, L., Branje, S., & Meeus, W. (2022). Using machine learning to identify early predictors of adolescent emotion regulation development. PsyArXiv. https://doi.org/10.31234/osf.io/rbqf9
